...
1. 历史版本到 `reports/inventory_dashboard/`
2. 最新版本到 `docs/dashboard/`
...
1. `docs/dashboard/index.html` 是否存在
2. `docs/dashboard/summary.md` 是否存在
3. `docs/dashboard/report.md` 是否存在
4. 仓库默认分支是否已推送最新内容
5. GitHub Pages 是否选择了 `main + /docs`
6. 页面打开后顶部是否先看到：
   - 今日经营重点
   - 核心经营指标
   - 赚钱机会
...
1. 本地有没有重新运行脚本
2. `docs/dashboard/index.html` 是否真的被刷新
3. 是否已经提交并 push 到远程仓库
4. GitHub Pages 设置是否还是 `main + /docs`
5. 浏览器是否缓存旧页面
